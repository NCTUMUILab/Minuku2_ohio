 ...
 * All events going around to the {@link edu.ohio.minukucore.manager.StreamManager} or
 * {@link edu.ohio.minukucore.manager.SituationManager} must extend this class.
 *
...
public class MinukuEvent {
    ...
    /**
     * Constructor.
     * @param anEventType The {@link edu.ohio.minukucore.model.DataRecord} type which this event
     * is associated with.
     */
