 ...
 * @see edu.ohio.minukucore.stream.Stream
 * @version 1.0
 */
public interface StreamManager {
     ...
     * @return a list of Stream class instances {@link edu.ohio.minukucore.stream.Stream}
     */
     ...
     * @param <T> the application specific DataRecord {@link edu.ohio.minukucore.model.DataRecord}
     * @throws StreamNotFoundException {@link edu.ohio.minukucore.exception.StreamNotFoundException}
     * @throws StreamAlreadyExistsException {@link edu.ohio.minukucore.exception.StreamAlreadyExistsException}
     */
     ...
     * {@link edu.ohio.minukucore.streamgenerator.StreamGenerator}
     * Subscribes to the state change event
     * {@link edu.ohio.minukucore.event.StateChangeEvent}
     * This method then calls the state change handler of the SituationManager
     * {@link edu.ohio.minukucore.manager.SituationManager}
     */
    @Subscribe
