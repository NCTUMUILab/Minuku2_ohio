...
package edu.ohio.minukucore.manager;
...
import edu.ohio.minukucore.situation.Situation;

/**
 * Created by shriti on 7/9/16.
 * A registry of all the {@link edu.ohio.minukucore.situation.Situation} situations
...
public interface SituationManager {
    ...
    /**
     * Called by {@link edu.ohio.minukucore.manager.StreamManager}.
     * Sends request to appropriate situations
     * Note: does not subscribe to any event on the event bus
     * @param s {@link edu.ohio.minukucore.model.StreamSnapshot}
     ...
     * {@link edu.ohio.minukucore.model.DataRecord} entry is expected.
     ...
     *      {@link edu.ohio.minukucore.model.DataRecord}s that the Situation depends on
